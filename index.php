...
<body>
    ...
    <main class="main">
        <section class="about section" id="about">
            ...
            <span class="section__subtitle">Développeur Web</span>
            ...
            <div class="about__container container grid">
                ...
                <div class="about_data">
                    <p class="about__description">Animé par le goût du challenge, j'aime me lancer des défis et sortir
                        de ma zone de confort.<br>Mon esprit d'équipe, mon aisance relationnelle et mes bonnes capacités
                        d'adaptation font de moi quelqu'un qui valorise le partage et la communication.<br><br>Passionné
                        par l'informatique depuis mon enfance, j'ai toujours aspiré à exercer un métier dans ce
                        secteur.<br>Les nouvelles technologies et l'informatique en général suscitent en moi une réelle
                        passion. En plus du goût du challenge et de l'aptitude à sortir de ma zone de confort, j'aime
                        apprendre de manière autonome de nouvelles technologies et de nouveaux logiciels.<br>L'esprit
                        d'équipe, le partage et la communication revêtent une importance capitale à mes yeux.<br><br>Mon
                        parcours et mes caractéristiques font de moi un candidat désireux d'intégrer un environnement
                        stimulant où je pourrais contribuer tout en continuant à me développer.<br>Permis B mais pas
                    ...
                    <div class="about__info">
                        ...
                        <div class="about__card">
                            <span class="about__info-title">3 ans</span>
                            <span class="about__info-name">d'experience de chef de projet</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="skills__content skills__close">
                        <div class="skills__header">
                            ...
                            <div>
                                <h1 class="skills__titles">Frameworks</h1>
                            </div>
                        ...
                        <div class="skills__list grid">
                            <div class="skills__container__list">
                                <div class="skills__img">
                                    <img src="assets/img/gatsby.svg" />
                                </div>
                                <div class="skills__data">
                                    <div class="skills__titles">
                                        <h3 class="skills__name">Gatsby</h3>
                                        <span class="skills__number">70%</span>
                                    </div>
                                    <div class="skills__bar">
                                        <span class="skills__percentage skills__gatsby"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="qualification__container container">
                ...
                <div class="qualification__sections">
                    <div class="qualification__content qualification__active" data-content id="education">
                        <div class="qualification__data">
                            <div class="qualification__card">
                                <h3 class="qualification__title">Titre RNCP 7 | Concepteur et développeur d'application
                                    - Chef de projet systèmes d'information - Numérique & Management</h3>
                                <span class="qualification__subtitle">
                                    <br />
                                    <ul>
                                        <li>Projet de groupe sur la création de site web vitrine et e-commerce et d'un
                                            back office pour le club de basket de Salon-de-Provence PSB13 en CakePHP et
                                            ReactJS pour un vrai client (Développeur)<br />Dans ce projet j'ai également
                                            eu l'occasion de gérer pendant une semaine une équipe de 4 développeurs de
                                            l'Institut G4 en première année</li>
                                        <li>Projet de groupe sur la création de site web vitrine et e-commerce et d'un
                                            back office pour des produits et services renouvelables en Symfony
                                            (Développeur)</li>
                                        <li>Projet de groupe sur la création d'une application sportive de rencontre en
                                            Flutter (Développeur)</li>
                                        <li>Projet de groupe sur la création d'une mascotte pour l'Institut G4
                                            (Développeur)</li>
                                        <li>Projet de groupe sur la création d'un site vitrine pour un musée fictif de
                                            marseille (Développeur + Designer (charte graphique))</li>
                                    </ul>
                                    <br />
                        ...
                        <div class="qualification__data">
                            ...
                            <div class="qualification__card">
                                <h3 class="qualification__title">Brevet de Technicien Supérieur Systèmes Numériques
                                    option Informatique et Réseaux</h3>
                                <span class="qualification__subtitle">
                                    <br />
                                    <ul>
                                        <li>Projet de groupe sur une station météo en C++ (Client et serveur TCP,
                                            récupèration et affichage de données dans un logiciel, micro base de
                                            données)</li>
                                        <li>Création d'interfaces homme-machine avec QT Creator connectées avec des
                                            capteurs, leds</li>
                                    </ul>
                                    <br />
                        ...
                        <div class="qualification__data">
                            <div class="qualification__card">
                                <h3 class="qualification__title">Baccalauréat Sciences et Technologies du Développement
                                    Durable option Energie Environnement – Mention Assez Bien</h3>
                                <span class="qualification__subtitle">
                                    <br />
                                    <ul>
                    ...
                    <div class="qualification__content" data-content id="work">
                        <div class="qualification__data">
                            <div class="qualification__card">
                                <h3 class="qualification__title">Alternance - Développeur Web </h3>
                                <span class="qualification__subtitle">
                                    <br />
                                    <ul>
                                        ...
                                        <li>Création d'un outil de création de sites web avec Gatsby (React et Python)
                                        </li>
                                        <li>Création de plateforme de formations e-learning sur WordPress avec le plugin
                                            LMS LearnDash</li>
                                        <li>Création d'un CRM sur mesure pour la gestion de stagiaires avec Laravel (PHP
                                            et VueJS)</li>
                                        <li>Création de plugins WordPress pour la création personnalisée de templates de
                                            mail (PHP)</li>
                                        <li>Utilisation d'APIs (PHP et JavaScript)</li>
                                    </ul>
                                    <br />
                                    Tekzone, Marseille
                                    <div class="qualification__calendar">
                            ...
                            <div class="qualification__card">
                                ...
                                <span class="qualification__subtitle">
                                    ...
                                    <ul>
                                        ...
                                        <li>Installation et configuration des rôles DHCP et DNS pour le partage de
                                            fichiers et de données</li>
                                        <li>Administration Réseau (création de sessions étudiantes Windows avec des
                                            droits limités)
                                            Surveillance de ressources avec Kaseya, logiciel de monitoring (Utilisation
                                            processeur, RAM, Disque Dur ...)</li>
                                    </ul>
                                    <br />
                                    OPTIMAL.SI, Manosque
                                </span>
                        ...
                        <div class="qualification__data">
                            ...
                            <div class="qualification__card">
                                ...
                                <span class="qualification__subtitle">
                                    <br />
                                    <ul>
                                        <li>Observation sur les postes informatiques, logiciels utilisés propres à
                                            l'entreprise (Pesée de poids lourds avec bennes à recycler, enregistrements
                                            base de données (nom, prénom, adresse, ville, poids du camion)</li>
                                    </ul>
                                    <br />
                        ...
                        <div class="services__modal-content">
                            ...
                            <ul class="services__modal-services grid">
                                <li class="services__modal-service">
                                    ...
                                    <p>Développement d'un back office avec gestion de données (CRUD : Création, lecture,
                                        modification et suppression de données en base de données par exemple)</p>
                                </li>
                                <li class="services__modal-service">
                ...
                <div class="swiper-wrapper">
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Flat Design et responsive avec charte graphique
                                personnalisée</p>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Produits pour particulier et Services pour professionnels
                            </p>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Création de charte graphique + site web pour une mascotte
                                de l'Institut G4</p>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            <h3 class="portfolio__title">Site vitrine et e-commerce du club de basket de salon PSB13
                            </h3>
                            <p class="portfolio__description">Refonte complète du site en utilisant CakePHP et ReactJS
                                psb13.fr
                            </p>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Application de rencontre sportive en Flutter<br>Création,
                                modification et suppression d'évènements sportfis avec géolocalisation, filtres et chat
                            </p>
                            <a href="/SportZ" target="_blank" class="button button--flex button--small portfolio__button">
                                Demo
                                <i class="uil uil-arrow-right button__icon"></i>
                            </a>
                        </div>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Classement Ligue 1, Premier League, Liga, Bundesliga,
                                Serie A utilisant du HTML, du CSS et du JavaScript pour la récupèration des données en
                                asynchrone</p>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Maintenance et mise à jour constante du site vitrine qui
                                met en avant les formations disponibles sur notre plateforme de formations en ligne</p>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Création maintenance et mise à jour du site vitrine qui
                                met en avant les différents services informatiques</a></p>
